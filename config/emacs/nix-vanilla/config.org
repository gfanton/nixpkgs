...
#+begin_src emacs-lisp
  ;; macOS-specific settings for terminal use (no GUI features)
  (when (eq system-type 'darwin)
    ...
    ;; Terminal-friendly keybindings (no GUI frame commands)
    ...
    (emacs-nix-log "macOS terminal configuration loaded"))
#+end_src
